...
- (void)commonInit {
    ...
    NSExpression *assigneeExpr = [NSExpression expressionForKeyPath:@"assignee.login"];
    ...
    NSPredicateEditorRowTemplate *userTemplate = [[UserRowTemplate alloc] initWithLeftExpressions:@[assigneeExpr, originatorExpr, resolverExpr]];
